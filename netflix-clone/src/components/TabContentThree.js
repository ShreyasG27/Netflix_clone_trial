    ...
    return(
       ...
       <div className="tab-content">
           <div className="tab-top-content">
                <span style={{fontSize: '1.2rem', marginTop: '0.8rem'}}>Choose one plan and watch everything on Netflix.</span>
                <Button className="btn-bt" style={{fontSize: '0.8rem'}}>Try it Now</Button>
           </div>
